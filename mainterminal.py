...
while True:
    ...
    if cmd[0:3] == "ver":
        ...
        if len(cmd) == 4:
            ...
            if cmd[5:7] == "-a":
                print("repeat exit ver display dir ls exec write qm.add qm.sub qm.mult qm.div restart crt cp pyexec mv qm.rand qm.fib qm.fac login contains whoami pwd mkdir")
            if cmd[5:8] == "ver":
